...
<?php
    ...
    foreach ($les_creneaux_demandes as $idcreneau) {
        ...
        echo '<DIV id="ancre'.$numero_creneau.'" class="unjourtitre"> Créneau du '.secu_ecran(jolie_date($le_creneau['date'])).' sur la période : '.secu_ecran($le_creneau['heure']);
...
?>
    ...
    <input hidden id="valeurancre" name="ancre" value="">
    </FORM><BR>
    <BUTTON onclick="valideFormulaire()">Afficher les demandes des joueurs pour ces créneaux</BUTTON>
    <BUTTON onclick="valideFormulaireTous()">Afficher les demandes des joueurs pour tous les créneaux</BUTTON>
...
<SCRIPT> 
document.querySelector("#ancre<?php echo $ancre;?>").scrollIntoView();
</SCRIPT>
</HTML>